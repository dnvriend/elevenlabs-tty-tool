...
`elevenlabs-tty-tool` is a Python CLI tool built with modern tooling and best practices.
...
make run ARGS="..."   # Run elevenlabs-tty-tool locally
...
```
elevenlabs-tty-tool/
├── elevenlabs_tty_tool/    # Main package
│   ├── __init__.py
